...
// [Color getter implementation remains the same]
...
class _StatsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const maxStat = 255.0; // Maximum possible base stat

    return SingleChildScrollView(
      padding: const EdgeInsets.all(24),
      child: Column(
        children: [
          _StatBar('HP', stats.hp.toDouble(), maxStat, StatColors.hp),
          _StatBar(
              'Attack', stats.attack.toDouble(), maxStat, StatColors.attack),
          _StatBar(
              'Defense', stats.defense.toDouble(), maxStat, StatColors.defense),
          _StatBar('Sp. Attack', stats.specialAttack.toDouble(), maxStat,
              StatColors.specialAttack),
          _StatBar('Sp. Defense', stats.specialDefense.toDouble(), maxStat,
              StatColors.specialDefense),
          _StatBar('Speed', stats.speed.toDouble(), maxStat, StatColors.speed),
          const SizedBox(height: 24),
          _StatBar(
              'Total', stats.total.toDouble(), maxStat * 6, StatColors.total),
        ],
      ),
    );
  }
